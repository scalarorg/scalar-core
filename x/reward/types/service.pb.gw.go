...
var (
	pattern_MsgService_RefundMsg_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "reward", "refund_message"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	pattern_QueryService_InflationRate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"scalar", "reward", "v1beta1", "inflation_rate", "validator"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_InflationRate_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"scalar", "reward", "v1beta1", "inflation_rate"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"scalar", "reward", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(true)))
)
