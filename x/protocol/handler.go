...
func NewHandler(k keeper.Keeper, covenant types.CovenantKeeper, permission types.PermissionKeeper, nexus types.NexusKeeper) sdk.Handler {
	server := keeper.NewMsgServerImpl(k, covenant, permission, nexus)
