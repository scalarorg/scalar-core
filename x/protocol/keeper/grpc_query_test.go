...
// 				covenantKeeper := covenant.NewKeeper(cfg.Codec, sdk.NewKVStoreKey(covenant.StoreKey), subspace)
// 				querier := keeper.NewGRPCQuerier(&k, &covenantKeeper)
// 				resp, err := querier.Protocols(sdk.WrapSDKContext(ctx), req)
