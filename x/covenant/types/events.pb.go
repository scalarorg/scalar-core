...
type CreatingPsbtStarted struct {
}

func (m *CreatingPsbtStarted) Reset()         { *m = CreatingPsbtStarted{} }
func (m *CreatingPsbtStarted) String() string { return proto.CompactTextString(m) }
func (*CreatingPsbtStarted) ProtoMessage()    {}
func (*CreatingPsbtStarted) Descriptor() ([]byte, []int) {
	return fileDescriptor_1539e454966a6a42, []int{0}
}
func (m *CreatingPsbtStarted) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CreatingPsbtStarted) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CreatingPsbtStarted.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *CreatingPsbtStarted) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreatingPsbtStarted.Merge(m, src)
}
func (m *CreatingPsbtStarted) XXX_Size() int {
	return m.Size()
}
func (m *CreatingPsbtStarted) XXX_DiscardUnknown() {
	xxx_messageInfo_CreatingPsbtStarted.DiscardUnknown(m)
}

var xxx_messageInfo_CreatingPsbtStarted proto.InternalMessageInfo
...
func init() {
	proto.RegisterType((*CreatingPsbtStarted)(nil), "scalar.covenant.v1beta1.CreatingPsbtStarted")
...
var fileDescriptor_1539e454966a6a42 = []byte{
	...
	,
}

func (m *CreatingPsbtStarted) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *CreatingPsbtStarted) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreatingPsbtStarted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CreatingPsbtStarted) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreatingPsbtStarted) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: CreatingPsbtStarted: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CreatingPsbtStarted: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
