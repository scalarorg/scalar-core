...
type SigningSession struct {
	...
	BatchPsbtPayload []PsbtPayload      `protobuf:"bytes,10,rep,name=batch_psbt_payload,json=batchPsbtPayload,proto3,casttype=PsbtPayload" json:"batch_psbt_payload,omitempty"`
}
...
func (m *SigningSession) GetBatchPsbtPayload() []PsbtPayload {
	if m != nil {
		return m.BatchPsbtPayload
	}
	return nil
}
...
var fileDescriptor_404fd62bcdc2fd38 = []byte{
	...
	,
}
...
func (m *SigningSession) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BatchPsbtPayload) > 0 {
		for iNdEx := len(m.BatchPsbtPayload) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTypes(dAtA, i, uint64(len(m.BatchPsbtPayload[iNdEx])))
			i--
			dAtA[i] = 0x52
		}
	}
