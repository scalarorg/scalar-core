...
import (
	...
	snapshotexported "github.com/scalarorg/scalar-core/x/snapshot/exported"
	"sync"
	"time"
)
...
//			},
//			GetSignatureFunc: func(p sdk.ValAddress) (ec.Signature, bool) {
...
func (mock *MultiSigMock) GetSignature(p sdk.ValAddress) (ec.Signature, bool) {
