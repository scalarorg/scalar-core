...
// source: scalar/tss/tofnd/v1beta1/multisig.proto
...
func (*KeygenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_323e4517fd619020, []int{0}
}
...
func (*KeygenResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_323e4517fd619020, []int{1}
}
...
func (*SignRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_323e4517fd619020, []int{2}
}
...
func (*SignResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_323e4517fd619020, []int{3}
}
...
func init() {
	proto.RegisterType((*KeygenRequest)(nil), "scalar.tss.tofnd.v1beta1.KeygenRequest")
	proto.RegisterType((*KeygenResponse)(nil), "scalar.tss.tofnd.v1beta1.KeygenResponse")
	proto.RegisterType((*SignRequest)(nil), "scalar.tss.tofnd.v1beta1.SignRequest")
	proto.RegisterType((*SignResponse)(nil), "scalar.tss.tofnd.v1beta1.SignResponse")
}

func init() {
	proto.RegisterFile("scalar/tss/tofnd/v1beta1/multisig.proto", fileDescriptor_323e4517fd619020)
}

var fileDescriptor_323e4517fd619020 = []byte{
	// 426 bytes of a gzipped FileDescriptorProto
	,
}
...
func NewMultisigClient(cc grpc1.ClientConn) MultisigClient {
...
func (c *multisigClient) KeyPresence(ctx context.Context, in *KeyPresenceRequest, opts ...grpc.CallOption) (*KeyPresenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/scalar.tss.tofnd.v1beta1.Multisig/KeyPresence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *multisigClient) Keygen(ctx context.Context, in *KeygenRequest, opts ...grpc.CallOption) (*KeygenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/scalar.tss.tofnd.v1beta1.Multisig/Keygen", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *multisigClient) Sign(ctx context.Context, in *SignRequest, opts ...grpc.CallOption) (*SignResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/scalar.tss.tofnd.v1beta1.Multisig/Sign", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMultisigServer can be embedded to have forward compatible implementations.
type UnimplementedMultisigServer struct {
}

func (*UnimplementedMultisigServer) KeyPresence(ctx context.Context, req *KeyPresenceRequest) (*KeyPresenceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method KeyPresence not implemented")
}
func (*UnimplementedMultisigServer) Keygen(ctx context.Context, req *KeygenRequest) (*KeygenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Keygen not implemented")
}
func (*UnimplementedMultisigServer) Sign(ctx context.Context, req *SignRequest) (*SignResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Sign not implemented")
}

func RegisterMultisigServer(s grpc1.Server, srv MultisigServer) {
	s.RegisterService(&_Multisig_serviceDesc, srv)
}
...
func _Multisig_KeyPresence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/scalar.tss.tofnd.v1beta1.Multisig/KeyPresence",
	}
...
func _Multisig_Keygen_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/scalar.tss.tofnd.v1beta1.Multisig/Keygen",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Multisig_Sign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/scalar.tss.tofnd.v1beta1.Multisig/Sign",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Multisig_serviceDesc = grpc.ServiceDesc{
	ServiceName: "scalar.tss.tofnd.v1beta1.Multisig",
	...
	Metadata: "scalar/tss/tofnd/v1beta1/multisig.proto",
}
