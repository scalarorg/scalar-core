...
var (
	pattern_MsgService_HeartBeat_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "tss", "heartbeat"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	pattern_QueryService_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"scalar", "tss", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(true)))
)
