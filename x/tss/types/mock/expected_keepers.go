...
//			GetActiveKeyIDsFunc: func(ctx github_com_cosmos_cosmos_sdk_types.Context, chainName github_com_scalarorg_scalar_core_x_nexus_exported.ChainName) []multisig.KeyID {
...
func (mock *MultiSigKeeperMock) GetActiveKeyIDs(ctx github_com_cosmos_cosmos_sdk_types.Context, chainName github_com_scalarorg_scalar_core_x_nexus_exported.ChainName) []multisig.KeyID {
