...
var TokenModel_name = map[int32]string{
	0: "TOKEN_MODEL_POOL",
	1: "TOKEN_MODEL_UTXO",
}

var TokenModel_value = map[string]int32{
	"TOKEN_MODEL_POOL": 0,
	"TOKEN_MODEL_UTXO": 1,
}

func (x TokenModel) String() string {
	return proto.EnumName(TokenModel_name, int32(x))
}

func (TokenModel) EnumDescriptor() ([]byte, []int) {
...
type Command struct {
	...
	// This field is used as extra data for the command, metadata is encoded in the payload, it can be fee information, etc.
...
type TokenDetails struct {
	...
	Model     TokenModel                             `protobuf:"varint,5,opt,name=model,proto3,enum=scalar.chains.v1beta1.TokenModel" json:"model,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("scalar.chains.v1beta1.TokenModel", TokenModel_name, TokenModel_value)
...
var fileDescriptor_033802ba77a026d0 = []byte{
	...
	,
}
