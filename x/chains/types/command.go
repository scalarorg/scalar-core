...
const (
	...
	deployToken2MaxGasCost                = 1400000
	registerCustodianGroupMaxGasCost      = 200000
...
func NewApproveRedeemTokenCommandWithPayload(
	...
	return Command{
		...
		Params:     createApproveRedeemTokenParams(sourceChain, sourceTxID, sourceEventIndex, sender, destinationContractAddress, payloadHash, amount, symbol),
		Payload:    payload,
		KeyID:      keyID,
		MaxGasCost: uint32(approveContractCallWithMintMaxGasCost),
	}
