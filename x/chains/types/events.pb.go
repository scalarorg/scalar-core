...
func (Event_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_76dc996153ba2dae, []int{20, 0}
}
...
type ConfirmNewBlockStarted struct {
	Chain github_com_scalarorg_scalar_core_x_nexus_exported.ChainName `protobuf:"bytes,1,opt,name=chain,proto3,casttype=github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" json:"chain,omitempty"`
	// in reverse byte order
	BlockHash                 github_com_scalarorg_scalar_core_x_chains_exported.Hash  `protobuf:"bytes,2,opt,name=block_hash,json=blockHash,proto3,customtype=github.com/scalarorg/scalar-core/x/chains/exported.Hash" json:"block_hash"`
	PreviousBlockHash         *github_com_scalarorg_scalar_core_x_chains_exported.Hash `protobuf:"bytes,3,opt,name=previous_block_hash,json=previousBlockHash,proto3,customtype=github.com/scalarorg/scalar-core/x/chains/exported.Hash" json:"previous_block_hash,omitempty"`
	ConfirmationHeight        uint64                                                   `protobuf:"varint,4,opt,name=confirmation_height,json=confirmationHeight,proto3" json:"confirmation_height,omitempty"`
	exported.PollParticipants `protobuf:"bytes,5,opt,name=participants,proto3,embedded=participants" json:"participants"`
}

func (m *ConfirmNewBlockStarted) Reset()         { *m = ConfirmNewBlockStarted{} }
func (m *ConfirmNewBlockStarted) String() string { return proto.CompactTextString(m) }
func (*ConfirmNewBlockStarted) ProtoMessage()    {}
func (*ConfirmNewBlockStarted) Descriptor() ([]byte, []int) {
	return fileDescriptor_76dc996153ba2dae, []int{4}
}
func (m *ConfirmNewBlockStarted) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ConfirmNewBlockStarted) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConfirmNewBlockStarted.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ConfirmNewBlockStarted) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConfirmNewBlockStarted.Merge(m, src)
}
func (m *ConfirmNewBlockStarted) XXX_Size() int {
	return m.Size()
}
func (m *ConfirmNewBlockStarted) XXX_DiscardUnknown() {
	xxx_messageInfo_ConfirmNewBlockStarted.DiscardUnknown(m)
}

var xxx_messageInfo_ConfirmNewBlockStarted proto.InternalMessageInfo
...
type EventNewBlockConfirmed struct {
	...
	PreviousBlockHash *github_com_scalarorg_scalar_core_x_chains_exported.Hash `protobuf:"bytes,2,opt,name=previous_block_hash,json=previousBlockHash,proto3,customtype=github.com/scalarorg/scalar-core/x/chains/exported.Hash" json:"previous_block_hash,omitempty"`
	MerkleRoot        github_com_scalarorg_scalar_core_x_chains_exported.Hash  `protobuf:"bytes,3,opt,name=merkle_root,json=merkleRoot,proto3,customtype=github.com/scalarorg/scalar-core/x/chains/exported.Hash" json:"merkle_root"`
	BlockHeight       uint64                                                   `protobuf:"varint,4,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
}

func (m *EventNewBlockConfirmed) Reset()         { *m = EventNewBlockConfirmed{} }
func (m *EventNewBlockConfirmed) String() string { return proto.CompactTextString(m) }
func (*EventNewBlockConfirmed) ProtoMessage()    {}
func (*EventNewBlockConfirmed) Descriptor() ([]byte, []int) {
	return fileDescriptor_76dc996153ba2dae, []int{19}
}
func (m *EventNewBlockConfirmed) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventNewBlockConfirmed) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventNewBlockConfirmed.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventNewBlockConfirmed) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventNewBlockConfirmed.Merge(m, src)
}
func (m *EventNewBlockConfirmed) XXX_Size() int {
	return m.Size()
}
func (m *EventNewBlockConfirmed) XXX_DiscardUnknown() {
	xxx_messageInfo_EventNewBlockConfirmed.DiscardUnknown(m)
}

var xxx_messageInfo_EventNewBlockConfirmed proto.InternalMessageInfo
...
type Event_NewBlockConfirmed struct {
	NewBlockConfirmed *EventNewBlockConfirmed `protobuf:"bytes,14,opt,name=new_block_confirmed,json=newBlockConfirmed,proto3,oneof" json:"new_block_confirmed,omitempty"`
}
...
func (*Event_NewBlockConfirmed) isEvent_Event()               {}
...
func (m *Event) GetNewBlockConfirmed() *EventNewBlockConfirmed {
	if x, ok := m.GetEvent().(*Event_NewBlockConfirmed); ok {
		return x.NewBlockConfirmed
	}
	return nil
}
...
func (*CommandBatchAborted) Descriptor() ([]byte, []int) {
	return fileDescriptor_76dc996153ba2dae, []int{29}
}
...
func (*ChainAdded) Descriptor() ([]byte, []int) {
	return fileDescriptor_76dc996153ba2dae, []int{30}
}
...
func init() {
	...
	proto.RegisterType((*ConfirmNewBlockStarted)(nil), "scalar.chains.v1beta1.ConfirmNewBlockStarted")
	...
	proto.RegisterType((*EventNewBlockConfirmed)(nil), "scalar.chains.v1beta1.EventNewBlockConfirmed")
...
var fileDescriptor_76dc996153ba2dae = []byte{
	...
	,
}
...
func (m *ConfirmNewBlockStarted) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ConfirmNewBlockStarted) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConfirmNewBlockStarted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.PreviousBlockHash != nil {
		{
			size := m.PreviousBlockHash.Size()
			i -= size
			if _, err := m.PreviousBlockHash.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintEvents(dAtA, i, uint64(size))
		}
...
func (m *EventNewBlockConfirmed) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventNewBlockConfirmed) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventNewBlockConfirmed) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	{
		size := m.MerkleRoot.Size()
		i -= size
		if _, err := m.MerkleRoot.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintEvents(dAtA, i, uint64(size))
	}
...
func (m *Event_NewBlockConfirmed) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Event_NewBlockConfirmed) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NewBlockConfirmed != nil {
		{
			size, err := m.NewBlockConfirmed.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ConfirmNewBlockStarted) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventNewBlockConfirmed) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Event_NewBlockConfirmed) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConfirmNewBlockStarted) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConfirmNewBlockStarted: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConfirmNewBlockStarted: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			m.PreviousBlockHash = &v
			if err := m.PreviousBlockHash.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *EventNewBlockConfirmed) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventNewBlockConfirmed: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventNewBlockConfirmed: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Event) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewBlockConfirmed", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &EventNewBlockConfirmed{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Event = &Event_NewBlockConfirmed{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
