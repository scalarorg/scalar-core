...
type ConfirmBtcNewBlockStarted struct {
	...
	BlockHash          github_com_scalarorg_scalar_core_x_chains_exported.Hash `protobuf:"bytes,4,opt,name=block_hash,json=blockHash,proto3,customtype=github.com/scalarorg/scalar-core/x/chains/exported.Hash" json:"block_hash"`
	PreviousBlockHash  github_com_scalarorg_scalar_core_x_chains_exported.Hash `protobuf:"bytes,5,opt,name=previous_block_hash,json=previousBlockHash,proto3,customtype=github.com/scalarorg/scalar-core/x/chains/exported.Hash" json:"previous_block_hash"`
...
func (m *ConfirmBtcNewBlockStarted) Reset()         { *m = ConfirmBtcNewBlockStarted{} }
func (m *ConfirmBtcNewBlockStarted) String() string { return proto.CompactTextString(m) }
func (*ConfirmBtcNewBlockStarted) ProtoMessage()    {}
func (*ConfirmBtcNewBlockStarted) Descriptor() ([]byte, []int) {
	return fileDescriptor_76dc996153ba2dae, []int{1}
}
func (m *ConfirmBtcNewBlockStarted) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ConfirmBtcNewBlockStarted) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConfirmBtcNewBlockStarted.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ConfirmBtcNewBlockStarted) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConfirmBtcNewBlockStarted.Merge(m, src)
}
func (m *ConfirmBtcNewBlockStarted) XXX_Size() int {
	return m.Size()
}
func (m *ConfirmBtcNewBlockStarted) XXX_DiscardUnknown() {
	xxx_messageInfo_ConfirmBtcNewBlockStarted.DiscardUnknown(m)
}

var xxx_messageInfo_ConfirmBtcNewBlockStarted proto.InternalMessageInfo
...
type EventBtcBlockHeader struct {
	...
	PreviousBlockHash github_com_scalarorg_scalar_core_x_chains_exported.Hash `protobuf:"bytes,2,opt,name=previous_block_hash,json=previousBlockHash,proto3,customtype=github.com/scalarorg/scalar-core/x/chains/exported.Hash" json:"previous_block_hash"`
...
func (m *EventBtcBlockHeader) Reset()         { *m = EventBtcBlockHeader{} }
func (m *EventBtcBlockHeader) String() string { return proto.CompactTextString(m) }
func (*EventBtcBlockHeader) ProtoMessage()    {}
func (*EventBtcBlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_76dc996153ba2dae, []int{19}
}
func (m *EventBtcBlockHeader) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventBtcBlockHeader) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventBtcBlockHeader.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventBtcBlockHeader) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventBtcBlockHeader.Merge(m, src)
}
func (m *EventBtcBlockHeader) XXX_Size() int {
	return m.Size()
}
func (m *EventBtcBlockHeader) XXX_DiscardUnknown() {
	xxx_messageInfo_EventBtcBlockHeader.DiscardUnknown(m)
}

var xxx_messageInfo_EventBtcBlockHeader proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*ConfirmBtcNewBlockStarted)(nil), "scalar.chains.v1beta1.ConfirmBtcNewBlockStarted")
	...
	proto.RegisterType((*EventBtcBlockHeader)(nil), "scalar.chains.v1beta1.EventBtcBlockHeader")
...
var fileDescriptor_76dc996153ba2dae = []byte{
	...
	,
}
...
func (m *ConfirmBtcNewBlockStarted) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ConfirmBtcNewBlockStarted) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConfirmBtcNewBlockStarted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventBtcBlockHeader) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventBtcBlockHeader) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventBtcBlockHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ConfirmBtcNewBlockStarted) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventBtcBlockHeader) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConfirmBtcNewBlockStarted) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConfirmBtcNewBlockStarted: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConfirmBtcNewBlockStarted: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *EventBtcBlockHeader) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventBtcBlockHeader: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventBtcBlockHeader: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
