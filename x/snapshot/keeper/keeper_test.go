...
import (
	...
	keeperMock "github.com/scalarorg/scalar-core/x/snapshot/keeper/mock"
	"github.com/scalarorg/scalar-core/x/snapshot/types"
	"github.com/scalarorg/scalar-core/x/snapshot/types/mock"
)
...
func TestKeeper(t *testing.T) {
	...
	givenKeeper := testutils.Given("snapshot keeper", func() {
		encCfg := appParams.MakeEncodingConfig()
		ctx = sdk.NewContext(fake.NewMultiStore(), tmproto.Header{}, false, log.TestingLogger()).
	...
	t.Run("CreateSnapshot", func(t *testing.T) {
		...
		whenAllParamsAreGood := testutils.When("all params are good", func() {
