...
var (
	pattern_MsgService_RegisterProxy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "snapshot", "register_proxy"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_DeactivateProxy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "snapshot", "deactivate_proxy"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	pattern_QueryService_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"scalar", "snapshot", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(true)))
)
