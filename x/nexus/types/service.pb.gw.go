...
import (
	...
	exported_0 "github.com/scalarorg/scalar-core/x/nexus/exported"
...
var (
	pattern_MsgService_RegisterChainMaintainer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "nexus", "register_chain_maintainer"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_DeregisterChainMaintainer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "nexus", "deregister_chain_maintainer"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_ActivateChain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "nexus", "activate_chain"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_DeactivateChain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "nexus", "deactivate_chain"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_RegisterAssetFee_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "nexus", "register_asset_fee"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_SetTransferRateLimit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "nexus", "set_transfer_rate_limit"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	pattern_QueryService_LatestDepositAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5, 1, 0, 4, 1, 5, 6}, []string{"scalar", "nexus", "v1beta1", "latest_deposit_address", "recipient_addr", "recipient_chain", "deposit_chain"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_TransfersForChain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"scalar", "nexus", "v1beta1", "transfers_for_chain", "chain", "state"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_FeeInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"scalar", "nexus", "v1beta1", "fee_info", "chain", "asset"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_FeeInfo_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"scalar", "nexus", "v1beta1", "fee"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_TransferFee_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5, 1, 0, 4, 1, 5, 6}, []string{"scalar", "nexus", "v1beta1", "transfer_fee", "source_chain", "destination_chain", "amount"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_TransferFee_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"scalar", "nexus", "v1beta1", "transfer_fee"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_Chains_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"scalar", "nexus", "v1beta1", "chains"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_Assets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"scalar", "nexus", "v1beta1", "assets", "chain"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_ChainState_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"scalar", "nexus", "v1beta1", "chain_state", "chain"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_ChainsByAsset_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"scalar", "nexus", "v1beta1", "chains_by_asset", "asset"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_RecipientAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"scalar", "nexus", "v1beta1", "recipient_address", "deposit_chain", "deposit_addr"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_ChainMaintainers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"scalar", "nexus", "v1beta1", "chain_maintainers", "chain"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_TransferRateLimit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"scalar", "nexus", "v1beta1", "transfer_rate_limit", "chain", "asset"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_Message_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"scalar", "nexus", "v1beta1", "message"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"scalar", "nexus", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(true)))
)
