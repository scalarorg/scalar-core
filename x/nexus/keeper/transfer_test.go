...
// 	testutils "github.com/scalarorg/scalar-core/x/nexus/exported/testutils"
...
// var (
// 	linkedAddr  = 50
// 	terra       = nexus.Chain{Name: "terra", Module: scalarnetTypes.ModuleName, SupportsForeignAssets: true}
// 	terra2      = nexus.Chain{Name: "terra-2", Module: scalarnetTypes.ModuleName, SupportsForeignAssets: true}
// 	terraAssets = []string{"uluna", "uusd"}
// 	avalanche   = nexus.Chain{Name: "avalanche", Module: chainsTypes.ModuleName, SupportsForeignAssets: true}
// 	chains      = []nexus.Chain{evm.Ethereum, scalarnet.Scalarnet, terra, terra2, avalanche}
// 	assets      = append([]string{scalarnet.NativeAsset, "external-erc-20"}, terraAssets...)
...
// 		source.Module = chainsTypes.ModuleName
// 		dest.Module = scalarnetTypes.ModuleName
...
// 		for _, asset := range assets {
// 			isNative := false
// 			if chain.Name == scalarnet.Scalarnet.Name && asset == scalarnet.NativeAsset {
// 				isNative = true
// 			}
