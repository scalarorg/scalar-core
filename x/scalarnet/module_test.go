...
// var (
// ctx           sdk.Context
// ibcModule     scalarnet.AxelarnetIBCModule
// k             keeper.Keeper
// n             *mock.NexusMock
...
// },
// }
// ibcModule = scalarnet.NewAxelarnetIBCModule(ibcTransfer.NewIBCModule(transferK), ibcK, scalarnet.NewRateLimiter(&k, n), n, bankK)
// })
//
