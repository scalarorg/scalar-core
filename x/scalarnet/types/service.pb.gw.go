...
var (
	pattern_MsgService_Link_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "scalarnet", "link"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_ConfirmDeposit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "scalarnet", "confirm_deposit"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_ExecutePendingTransfers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "scalarnet", "execute_pending_transfers"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_AddCosmosBasedChain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "scalarnet", "add_cosmos_based_chain"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_RegisterAsset_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "scalarnet", "register_asset"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_RouteIBCTransfers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "scalarnet", "route_ibc_transfers"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_RegisterFeeCollector_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "scalarnet", "register_fee_collector"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_RetryIBCTransfer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "scalarnet", "retry_ibc_transfer"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_RouteMessage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "scalarnet", "route_message"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_CallContract_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"scalar", "scalarnet", "call_contract"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	pattern_QueryService_PendingIBCTransferCount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"scalar", "scalarnet", "v1beta1", "ibc_transfer_count"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"scalar", "scalarnet", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_IBCPath_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"scalar", "scalarnet", "v1beta1", "ibc_path", "chain"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_QueryService_ChainByIBCPath_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"scalar", "scalarnet", "v1beta1", "chain_by_ibc_path", "ibc_path"}, "", runtime.AssumeColonVerbOpt(true)))
)
