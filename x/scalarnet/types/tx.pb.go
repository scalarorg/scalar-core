...
type LinkRequest struct {
	...
	RecipientChain github_com_scalarorg_scalar_core_x_nexus_exported.ChainName `protobuf:"bytes,3,opt,name=recipient_chain,json=recipientChain,proto3,casttype=github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" json:"recipient_chain,omitempty"`
...
type AddCosmosBasedChainRequest struct {
	...
	CosmosChain github_com_scalarorg_scalar_core_x_nexus_exported.ChainName `protobuf:"bytes,6,opt,name=cosmos_chain,json=cosmosChain,proto3,casttype=github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" json:"cosmos_chain,omitempty"`
...
type RetryIBCTransferRequest struct {
	Sender github_com_cosmos_cosmos_sdk_types.AccAddress                `protobuf:"bytes,1,opt,name=sender,proto3,casttype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"sender,omitempty"`
	Chain  github_com_scalarorg_scalar_core_x_nexus_exported.ChainName  `protobuf:"bytes,2,opt,name=chain,proto3,casttype=github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" json:"chain,omitempty"` // Deprecated: Do not use.
	ID     github_com_scalarorg_scalar_core_x_nexus_exported.TransferID `protobuf:"varint,3,opt,name=id,proto3,casttype=github.com/scalarorg/scalar-core/x/nexus/exported.TransferID" json:"id,omitempty"`
}
...
var fileDescriptor_a935586470061b9a = []byte{
	...
	,
}
...
func (m *AddCosmosBasedChainRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.CosmosChain = github_com_scalarorg_scalar_core_x_nexus_exported.ChainName(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
