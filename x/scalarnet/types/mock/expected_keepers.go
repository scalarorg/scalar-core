...
// Ensure, that BaseKeeperMock does implement scalarnettypes.BaseKeeper.
// If this is not the case, regenerate this file with moq.
var _ scalarnettypes.BaseKeeper = &BaseKeeperMock{}

// BaseKeeperMock is a mock implementation of scalarnettypes.BaseKeeper.
//
//	func TestSomethingThatUsesBaseKeeper(t *testing.T) {
//
//		// make and configure a mocked scalarnettypes.BaseKeeper
//		mockedBaseKeeper := &BaseKeeperMock{
//			EnqueueIBCTransferFunc: func(ctx cosmossdktypes.Context, transfer scalarnettypes.IBCTransfer) error {
//				panic("mock out the EnqueueIBCTransfer method")
//			},
//			GetChainNameByIBCPathFunc: func(ctx cosmossdktypes.Context, ibcPath string) (github_com_scalarorg_scalar_core_x_nexus_exported.ChainName, bool) {
//				panic("mock out the GetChainNameByIBCPath method")
//			},
//			GetCosmosChainByNameFunc: func(ctx cosmossdktypes.Context, chain github_com_scalarorg_scalar_core_x_nexus_exported.ChainName) (scalarnettypes.CosmosChain, bool) {
//				panic("mock out the GetCosmosChainByName method")
//			},
//			GetCosmosChainsFunc: func(ctx cosmossdktypes.Context) []github_com_scalarorg_scalar_core_x_nexus_exported.ChainName {
...
//			},
//			GetParamsFunc: func(ctx cosmossdktypes.Context) scalarnettypes.Params {
...
//			},
//			SetSeqIDMappingFunc: func(ctx cosmossdktypes.Context, t scalarnettypes.IBCTransfer) error {
//				panic("mock out the SetSeqIDMapping method")
//			},
//			SetTransferFailedFunc: func(ctx cosmossdktypes.Context, transferID github_com_scalarorg_scalar_core_x_nexus_exported.TransferID) error {
//				panic("mock out the SetTransferFailed method")
//			},
//		}
//
//		// use mockedBaseKeeper in code that requires scalarnettypes.BaseKeeper
...
type BaseKeeperMock struct {
	...
	calls struct {
		...
		EnqueueIBCTransfer []struct {
			...
			Transfer scalarnettypes.IBCTransfer
		}
		...
		SetTransferFailed []struct {
			...
			TransferID github_com_scalarorg_scalar_core_x_nexus_exported.TransferID
		}
	}
...
func (mock *BaseKeeperMock) EnqueueIBCTransfer(ctx cosmossdktypes.Context, transfer scalarnettypes.IBCTransfer) error {
...
func (mock *BaseKeeperMock) GetChainNameByIBCPath(ctx cosmossdktypes.Context, ibcPath string) (github_com_scalarorg_scalar_core_x_nexus_exported.ChainName, bool) {
...
func (mock *BaseKeeperMock) GetCosmosChainByName(ctx cosmossdktypes.Context, chain github_com_scalarorg_scalar_core_x_nexus_exported.ChainName) (scalarnettypes.CosmosChain, bool) {
...
func (mock *BaseKeeperMock) GetCosmosChains(ctx cosmossdktypes.Context) []github_com_scalarorg_scalar_core_x_nexus_exported.ChainName {
...
func (mock *BaseKeeperMock) GetIBCPath(ctx cosmossdktypes.Context, chain github_com_scalarorg_scalar_core_x_nexus_exported.ChainName) (string, bool) {
...
func (mock *BaseKeeperMock) GetParams(ctx cosmossdktypes.Context) scalarnettypes.Params {
...
func (mock *BaseKeeperMock) SetSeqIDMapping(ctx cosmossdktypes.Context, t scalarnettypes.IBCTransfer) error {
...
func (mock *BaseKeeperMock) SetTransferFailed(ctx cosmossdktypes.Context, transferID github_com_scalarorg_scalar_core_x_nexus_exported.TransferID) error {
...
// Ensure, that NexusMock does implement scalarnettypes.Nexus.
// If this is not the case, regenerate this file with moq.
var _ scalarnettypes.Nexus = &NexusMock{}

// NexusMock is a mock implementation of scalarnettypes.Nexus.
//
//	func TestSomethingThatUsesNexus(t *testing.T) {
//
//		// make and configure a mocked scalarnettypes.Nexus
...
//			},
//			ArchivePendingTransferFunc: func(ctx cosmossdktypes.Context, transfer github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainTransfer)  {
...
//			},
//			EnqueueForTransferFunc: func(ctx cosmossdktypes.Context, sender github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress, amount cosmossdktypes.Coin) (github_com_scalarorg_scalar_core_x_nexus_exported.TransferID, error) {
//				panic("mock out the EnqueueForTransfer method")
//			},
//			EnqueueTransferFunc: func(ctx cosmossdktypes.Context, senderChain github_com_scalarorg_scalar_core_x_nexus_exported.Chain, recipient github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress, asset cosmossdktypes.Coin) (github_com_scalarorg_scalar_core_x_nexus_exported.TransferID, error) {
...
//				panic("mock out the GetParams method")
//			},
//			GetRecipientFunc: func(ctx cosmossdktypes.Context, sender github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress) (github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress, bool) {
...
//				panic("mock out the Logger method")
//			},
//			MarkTransferAsFailedFunc: func(ctx cosmossdktypes.Context, transfer github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainTransfer)  {
//				panic("mock out the MarkTransferAsFailed method")
//			},
//			NewLockableAssetFunc: func(ctx cosmossdktypes.Context, ibc nexustypes.IBCKeeper, bank nexustypes.BankKeeper, coin cosmossdktypes.Coin) (github_com_scalarorg_scalar_core_x_nexus_exported.LockableAsset, error) {
...
//			},
//			RegisterAssetFunc: func(ctx cosmossdktypes.Context, chain github_com_scalarorg_scalar_core_x_nexus_exported.Chain, asset github_com_scalarorg_scalar_core_x_nexus_exported.Asset, limit cosmossdktypes.Uint, window time.Duration) error {
...
//			},
//			SetChainFunc: func(ctx cosmossdktypes.Context, chain github_com_scalarorg_scalar_core_x_nexus_exported.Chain)  {
...
//			},
//			ValidateAddressFunc: func(ctx cosmossdktypes.Context, address github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress) error {
//				panic("mock out the ValidateAddress method")
//			},
//		}
//
//		// use mockedNexus in code that requires scalarnettypes.Nexus
//		// and then make assertions.
//
//	}
type NexusMock struct {
	...
	calls struct {
		...
		ValidateAddress []struct {
			...
			Address github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress
		}
	}
...
func (mock *NexusMock) ArchivePendingTransfer(ctx cosmossdktypes.Context, transfer github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainTransfer) {
...
func (mock *NexusMock) EnqueueForTransfer(ctx cosmossdktypes.Context, sender github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress, amount cosmossdktypes.Coin) (github_com_scalarorg_scalar_core_x_nexus_exported.TransferID, error) {
...
func (mock *NexusMock) EnqueueTransfer(ctx cosmossdktypes.Context, senderChain github_com_scalarorg_scalar_core_x_nexus_exported.Chain, recipient github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress, asset cosmossdktypes.Coin) (github_com_scalarorg_scalar_core_x_nexus_exported.TransferID, error) {
...
func (mock *NexusMock) GetRecipient(ctx cosmossdktypes.Context, sender github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress) (github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress, bool) {
...
func (mock *NexusMock) GetTransfersForChainPaginated(ctx cosmossdktypes.Context, chain github_com_scalarorg_scalar_core_x_nexus_exported.Chain, state github_com_scalarorg_scalar_core_x_nexus_exported.TransferState, pageRequest *query.PageRequest) ([]github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainTransfer, *query.PageResponse, error) {
...
func (mock *NexusMock) MarkTransferAsFailed(ctx cosmossdktypes.Context, transfer github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainTransfer) {
...
func (mock *NexusMock) NewLockableAsset(ctx cosmossdktypes.Context, ibc nexustypes.IBCKeeper, bank nexustypes.BankKeeper, coin cosmossdktypes.Coin) (github_com_scalarorg_scalar_core_x_nexus_exported.LockableAsset, error) {
...
func (mock *NexusMock) RegisterAsset(ctx cosmossdktypes.Context, chain github_com_scalarorg_scalar_core_x_nexus_exported.Chain, asset github_com_scalarorg_scalar_core_x_nexus_exported.Asset, limit cosmossdktypes.Uint, window time.Duration) error {
...
func (mock *NexusMock) SetChain(ctx cosmossdktypes.Context, chain github_com_scalarorg_scalar_core_x_nexus_exported.Chain) {
...
func (mock *NexusMock) ValidateAddress(ctx cosmossdktypes.Context, address github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress) error {
...
// Ensure, that BankKeeperMock does implement scalarnettypes.BankKeeper.
// If this is not the case, regenerate this file with moq.
var _ scalarnettypes.BankKeeper = &BankKeeperMock{}

// BankKeeperMock is a mock implementation of scalarnettypes.BankKeeper.
//
//	func TestSomethingThatUsesBankKeeper(t *testing.T) {
//
//		// make and configure a mocked scalarnettypes.BankKeeper
...
//		}
//
//		// use mockedBankKeeper in code that requires scalarnettypes.BankKeeper
//		// and then make assertions.
//
//	}
...
// Ensure, that IBCTransferKeeperMock does implement scalarnettypes.IBCTransferKeeper.
// If this is not the case, regenerate this file with moq.
var _ scalarnettypes.IBCTransferKeeper = &IBCTransferKeeperMock{}

// IBCTransferKeeperMock is a mock implementation of scalarnettypes.IBCTransferKeeper.
//
//	func TestSomethingThatUsesIBCTransferKeeper(t *testing.T) {
//
//		// make and configure a mocked scalarnettypes.IBCTransferKeeper
...
//		}
//
//		// use mockedIBCTransferKeeper in code that requires scalarnettypes.IBCTransferKeeper
//		// and then make assertions.
//
//	}
...
// Ensure, that ChannelKeeperMock does implement scalarnettypes.ChannelKeeper.
// If this is not the case, regenerate this file with moq.
var _ scalarnettypes.ChannelKeeper = &ChannelKeeperMock{}

// ChannelKeeperMock is a mock implementation of scalarnettypes.ChannelKeeper.
//
//	func TestSomethingThatUsesChannelKeeper(t *testing.T) {
//
//		// make and configure a mocked scalarnettypes.ChannelKeeper
...
//		}
//
//		// use mockedChannelKeeper in code that requires scalarnettypes.ChannelKeeper
//		// and then make assertions.
//
//	}
...
// Ensure, that AccountKeeperMock does implement scalarnettypes.AccountKeeper.
// If this is not the case, regenerate this file with moq.
var _ scalarnettypes.AccountKeeper = &AccountKeeperMock{}

// AccountKeeperMock is a mock implementation of scalarnettypes.AccountKeeper.
//
//	func TestSomethingThatUsesAccountKeeper(t *testing.T) {
//
//		// make and configure a mocked scalarnettypes.AccountKeeper
...
//		}
//
//		// use mockedAccountKeeper in code that requires scalarnettypes.AccountKeeper
//		// and then make assertions.
//
//	}
...
// Ensure, that PortKeeperMock does implement scalarnettypes.PortKeeper.
// If this is not the case, regenerate this file with moq.
var _ scalarnettypes.PortKeeper = &PortKeeperMock{}

// PortKeeperMock is a mock implementation of scalarnettypes.PortKeeper.
//
//	func TestSomethingThatUsesPortKeeper(t *testing.T) {
//
//		// make and configure a mocked scalarnettypes.PortKeeper
...
//		}
//
//		// use mockedPortKeeper in code that requires scalarnettypes.PortKeeper
//		// and then make assertions.
//
//	}
...
// Ensure, that GovKeeperMock does implement scalarnettypes.GovKeeper.
// If this is not the case, regenerate this file with moq.
var _ scalarnettypes.GovKeeper = &GovKeeperMock{}

// GovKeeperMock is a mock implementation of scalarnettypes.GovKeeper.
//
//	func TestSomethingThatUsesGovKeeper(t *testing.T) {
//
//		// make and configure a mocked scalarnettypes.GovKeeper
...
//		}
//
//		// use mockedGovKeeper in code that requires scalarnettypes.GovKeeper
//		// and then make assertions.
//
//	}
...
// Ensure, that StakingKeeperMock does implement scalarnettypes.StakingKeeper.
// If this is not the case, regenerate this file with moq.
var _ scalarnettypes.StakingKeeper = &StakingKeeperMock{}

// StakingKeeperMock is a mock implementation of scalarnettypes.StakingKeeper.
//
//	func TestSomethingThatUsesStakingKeeper(t *testing.T) {
//
//		// make and configure a mocked scalarnettypes.StakingKeeper
...
//		}
//
//		// use mockedStakingKeeper in code that requires scalarnettypes.StakingKeeper
//		// and then make assertions.
//
//	}
...
// Ensure, that FeegrantKeeperMock does implement scalarnettypes.FeegrantKeeper.
// If this is not the case, regenerate this file with moq.
var _ scalarnettypes.FeegrantKeeper = &FeegrantKeeperMock{}

// FeegrantKeeperMock is a mock implementation of scalarnettypes.FeegrantKeeper.
//
//	func TestSomethingThatUsesFeegrantKeeper(t *testing.T) {
//
//		// make and configure a mocked scalarnettypes.FeegrantKeeper
...
//		}
//
//		// use mockedFeegrantKeeper in code that requires scalarnettypes.FeegrantKeeper
//		// and then make assertions.
//
//	}
...
// Ensure, that IBCKeeperMock does implement scalarnettypes.IBCKeeper.
// If this is not the case, regenerate this file with moq.
var _ scalarnettypes.IBCKeeper = &IBCKeeperMock{}

// IBCKeeperMock is a mock implementation of scalarnettypes.IBCKeeper.
//
//	func TestSomethingThatUsesIBCKeeper(t *testing.T) {
//
//		// make and configure a mocked scalarnettypes.IBCKeeper
...
//			},
//			SendMessageFunc: func(c context.Context, recipient github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress, asset cosmossdktypes.Coin, payload string, id string) error {
//				panic("mock out the SendMessage method")
//			},
//		}
//
//		// use mockedIBCKeeper in code that requires scalarnettypes.IBCKeeper
//		// and then make assertions.
//
//	}
...
func (mock *IBCKeeperMock) SendMessage(c context.Context, recipient github_com_scalarorg_scalar_core_x_nexus_exported.CrossChainAddress, asset cosmossdktypes.Coin, payload string, id string) error {
