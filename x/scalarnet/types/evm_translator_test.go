...
// 		msg := nexustestutils.RandomMessage()
// 		payload := scalartestutils.PackPayloadWithVersion("0x99999999", rand.Bytes(64))
...
// 		msg := nexustestutils.RandomMessage()
// 		payload := scalartestutils.PackPayloadWithVersion(version, rand.Bytes(10))
...
// 		payload := scalartestutils.PackPayloadWithVersion(version, bz)
// 		_, err = types.TranslateMessage(msg, payload)
...
// 		payload := scalartestutils.PackPayloadWithVersion(version, wasmMsg)
...
// 		wasmMsg := []byte(`
// {
// "contract_name": {"source_chain": "ethereum", "source_address": "scalar123"}
// }
// `)
...
// 		msg := nexustestutils.RandomMessage()
// 		payload := scalartestutils.PackPayloadWithVersion(types.NativeV1, payloadMsg)
...
// 	return scalartestutils.PackPayloadWithVersion(types.CosmWasmV1, payload), nil
// }
