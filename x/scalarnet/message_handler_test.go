...
// 	sourceChannel := scalartestutils.RandomChannel()
// 	receiverChannel := scalartestutils.RandomChannel()
...
// 			Name:       srcChain.Name,
// 			IBCPath:    scalartestutils.RandomIBCPath(),
// 			AddrPrefix: "cosmos",
// 		}))
...
// 		packet = scalartestutils.RandomPacket(ics20Packet, ibctransfertypes.PortID, sourceChannel, ibctransfertypes.PortID, receiverChannel)
// 	}

// 	givenPacketWithMessage.
// 		When("packet receiver is not Scalar gmp account", nonGMPPacket).
...
// 			ics20Packet = ibctransfertypes.NewFungibleTokenPacketData(
// 				rand.Denom(5, 10), strconv.FormatInt(rand.PosI64(), 10), rand.AccAddr().String(), types.ScalarIBCAccount.String(),
// 			)
...
// 		When("dest chain is evm", func() { destChain.Module = chainsTypes.ModuleName }).
...
// 				funcs.MustNoErr(k.SetCosmosChain(ctx, types.CosmosChain{
// 					Name:       destChain.Name,
// 					IBCPath:    types.NewIBCPath(ibctransfertypes.PortID, scalartestutils.RandomChannel()),
...
// 		// packet send to  gmp account
// 		denom = rand.Denom(5, 10)
// 		amount = strconv.FormatInt(rand.PosI64(), 10)
// 		ics20Packet = ibctransfertypes.NewFungibleTokenPacketData(
// 			denom, amount, rand.AccAddr().String(), types.ScalarIBCAccount.String(),
// 		)
// 		ics20Packet.Memo = string(funcs.Must(json.Marshal(message)))
// 		packet = scalartestutils.RandomPacket(ics20Packet, ibctransfertypes.PortID, sourceChannel, ibctransfertypes.PortID, receiverChannel)
...
// 				if addr.Equals(types.ScalarIBCAccount) {
