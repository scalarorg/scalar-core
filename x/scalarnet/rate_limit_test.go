...
// scalarnettestutils "github.com/scalarorg/scalar-core/x/scalarnet/types/testutils"
// )
//
...
// denom       string
// baseDenom   string
// rateLimiter scalarnet.RateLimiter
// n           *mock.NexusMock
// err         error
...
// ctx, k, _ = setup()
// n = &mock.NexusMock{}
// rateLimiter = scalarnet.NewRateLimiter(&k, n)
// })
//
...
// )
// packet = scalarnettestutils.RandomPacket(transfer, sourcePort, sourceChannel, receiverPort, receiverChannel)
...
// denom, strconv.FormatInt(rand.PosI64(), 10), rand.AccAddr().String(), rand.AccAddr().String(),
// )
// packet = scalarnettestutils.RandomPacket(transfer, port, channel, receiverPort, receiverChannel)
// }).
// When2(whenIBCPathIsRegistered).
// When2(whenChainIsRegistered).
...
// transfer    ibctransfertypes.FungibleTokenPacketData
// denom       string
// rateLimiter scalarnet.RateLimitedICS4Wrapper
// n           *mock.NexusMock
...
// n = &mock.NexusMock{}
// rateLimiter = scalarnet.NewRateLimitedICS4Wrapper(channelK, scalarnet.NewRateLimiter(&k, n), &k)
// })
//
// givenPacket := Given("a random ICS-20 packet", func() {
// denom = scalarnettestutils.RandomFullDenom()
// transfer = ibctransfertypes.NewFungibleTokenPacketData(
// denom, strconv.FormatInt(rand.PosI64(), 10), rand.AccAddr().String(), rand.AccAddr().String(),
// )
// packet = scalarnettestutils.RandomPacket(transfer, port, channel, rand.StrBetween(1, 20), rand.StrBetween(1, 20))
// chain = nexustestutils.RandomChainName()
// })
//
// givenKeeper.
...
// axelarnetSubspace := params.NewSubspace(encCfg.Codec, encCfg.Amino, sdk.NewKVStoreKey("axelarnetKey"), sdk.NewKVStoreKey("tAxelarnetKey"), "scalarnet")
// ctx := sdk.NewContext(fake.NewMultiStore(), tmproto.Header{}, false, log.TestingLogger())
//
// channelK := &mock.ChannelKeeperMock{}
//
// k := keeper.NewKeeper(encCfg.Codec, sdk.NewKVStoreKey("scalarnet"), axelarnetSubspace, channelK, &mock.FeegrantKeeperMock{})
