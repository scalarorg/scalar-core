...
// Keeper provides access to all state changes regarding the Scalarnet module
type Keeper struct {
...
// NewKeeper returns a new scalarnet keeper
...
// GetRouteTimeoutWindow returns the timeout window for IBC transfers routed by scalarnet
...
// GetTransferLimit returns the transfer limit for transfers processed by scalarnet
...
// GetEndBlockerLimit returns the transfer limit for IBC transfers routed in the end blocker by scalarnet
...
// GetFeeCollector gets scalarnet fee collector
