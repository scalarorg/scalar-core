...
var (
	_ servertypes.Application = (*ScalarApp)(nil)
)
...
func NewScalarApp(
	...
	appModules := initAppModules(
		...
		encodingConfig,
		appOpts,
		scalarnet.NewAppModule(
			*GetKeeper[scalarnetKeeper.IBCKeeper](keepers),
			GetKeeper[nexusKeeper.Keeper](keepers),
			bankKepper.NewBankKeeper(GetKeeper[bankkeeper.BaseKeeper](keepers)),
...
func InitICS4Wrapper(keepers *KeeperCache, wasmHooks *ibchooks.WasmHooks) ibchooks.ICS4Middleware {
	...
	ics4Wrapper := scalarnet.NewRateLimitedICS4Wrapper(
...
func initIBCRouter(keepers *KeeperCache, scalarnetModule porttypes.IBCModule) *porttypes.Router {
	// Finalize the IBC router
	// Create static IBC router, add scalarnet module as the IBC transfer route, and seal it
	ibcRouter := porttypes.NewRouter()
	ibcRouter.AddRoute(ibctransfertypes.ModuleName, scalarnetModule)
	if IsWasmEnabled() {
...
func (app *ScalarApp) registerWasmSnapshotExtension(keepers *KeeperCache) {
...
func (app *ScalarApp) setUpgradeBehaviour(configurator module.Configurator, keepers *KeeperCache) {
...
func initBaseApp(db dbm.DB, traceStore io.Writer, encodingConfig appParams.EncodingConfig, keepers *KeeperCache, baseAppOptions []func(*bam.BaseApp), logger log.Logger) *bam.BaseApp {
...
func initAnteHandlers(encodingConfig appParams.EncodingConfig, keys map[string]*sdk.KVStoreKey, keepers *KeeperCache, appOpts servertypes.AppOptions) sdk.AnteHandler {
...
func initMessageAnteDecorators(encodingConfig appParams.EncodingConfig, keepers *KeeperCache) ante.MessageAnteHandler {
...
func (app *ScalarApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *ScalarApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker calls the EndBlock() function of every module at the end of a block
func (app *ScalarApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// LoadHeight loads the application version at a given height. It will panic if called
// more than once on a running baseapp.
func (app *ScalarApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// AppCodec returns ScalarApp's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *ScalarApp) AppCodec() codec.Codec {
	return app.appCodec
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *ScalarApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *ScalarApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *ScalarApp) RegisterTendermintService(clientCtx client.Context) {
	...
	managers := []module.AppModuleBasic{
		...
		gov.NewAppModuleBasic(
			append(
				...
				scalarnetclient.ProposalHandler,
			)...,
		),
