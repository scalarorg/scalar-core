...
// file.
func (app *ScalarApp) ExportAppStateAndValidators(forZeroHeight bool, jailAllowedAddrs []string) (servertypes.ExportedApp, error) {
...
func (app *ScalarApp) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) {
