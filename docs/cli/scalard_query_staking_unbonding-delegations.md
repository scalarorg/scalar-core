## scalard query staking unbonding-delegations
...
Example:
$ <appd> query staking unbonding-delegations scalar1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p

```
scalard query staking unbonding-delegations [delegator-addr] [flags]
```
