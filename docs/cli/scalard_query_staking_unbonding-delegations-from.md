## scalard query staking unbonding-delegations-from
...
Example:
$ <appd> query staking unbonding-delegations-from scalarvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj

```
scalard query staking unbonding-delegations-from [validator-addr] [flags]
```
