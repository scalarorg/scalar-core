## scalard query staking redelegations-from
...
Example:
$ <appd> query staking redelegations-from scalarvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj

```
scalard query staking redelegations-from [validator-addr] [flags]
```
