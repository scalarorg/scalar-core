## scalard query staking redelegations
...
Example:
$ <appd> query staking redelegation scalar1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p

```
scalard query staking redelegations [delegator-addr] [flags]
```
