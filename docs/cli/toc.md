...
- [scalard](scalard.md)	 - Scalar App
	...
	- [query](scalard_query.md)	 - Querying subcommands
		...
		- [chains](scalard_query_chains.md)	 - Querying commands for the chains module
			- [address [chain]](scalard_query_chains_address.md)	 - Returns the EVM address
			- [batched-commands [chain] [batchedCommandsID]](scalard_query_chains_batched-commands.md)	 - Get the signed batched commands that can be wrapped in an transaction to be executed in Scalar Gateway
			- [burner-info [deposit address]](scalard_query_chains_burner-info.md)	 - Get information about a burner address
			- [bytecode [chain] [contract]](scalard_query_chains_bytecode.md)	 - Fetch the bytecode of an EVM contract [contract] for chain [chain]
		...
		- [protocol](scalard_query_protocol.md)	 - Querying commands for the protocol module
	...
	- [tx](scalard_tx.md)	 - Transactions subcommands
		...
		- [chains](scalard_tx_chains.md)	 - chains transactions subcommands
			- [add-chain [name] [chain config]](scalard_tx_chains_add-chain.md)	 - Add a new EVM chain
			- [confirm-erc20-deposit [chain] [txID] [burnerAddr]](scalard_tx_chains_confirm-erc20-deposit.md)	 - Confirm ERC20 deposits in an EVM chain transaction to a burner address
			- [confirm-erc20-token [chain] [origin chain] [origin asset] [txID]](scalard_tx_chains_confirm-erc20-token.md)	 - Confirm an ERC20 token deployment in an EVM chain transaction for a given asset of some origin chain and gateway address
			- [confirm-source-txs \<chain\> \<txID\>...](scalard_tx_chains_confirm-source-txs.md)	 - Confirm source transactions in a chain
			- [confirm-transfer-operatorship [chain] [txID]](scalard_tx_chains_confirm-transfer-operatorship.md)	 - Confirm a transfer operatorship in an EVM chain transaction
			- [create-burn-tokens [chain]](scalard_tx_chains_create-burn-tokens.md)	 - Create burn commands for all confirmed token deposits in an EVM chain
			- [create-deploy-token [evm chain] [origin chain] [origin asset] [token name] [symbol] [decimals] [capacity] [mintLimit]](scalard_tx_chains_create-deploy-token.md)	 - Create a deploy token command with the ScalarGateway contract
			- [create-pending-transfers [chain]](scalard_tx_chains_create-pending-transfers.md)	 - Create commands for handling all pending transfers to an EVM chain
			- [link [chain] [recipient chain] [recipient address] [asset name]](scalard_tx_chains_link.md)	 - Link a cross chain address to an EVM chain address created by Scalar
			- [set-gateway [chain] [address]](scalard_tx_chains_set-gateway.md)	 - Set the gateway address for the given evm chain
			- [sign-btc-commands [chain]](scalard_tx_chains_sign-btc-commands.md)	 - Sign pending commands for a BTC chain contract
			- [sign-commands [chain]](scalard_tx_chains_sign-commands.md)	 - Sign pending commands for an EVM chain contract
			- [transfer-operatorship [chain] [keyID]](scalard_tx_chains_transfer-operatorship.md)	 - Create transfer operatorship command for an EVM chain contract
		- [covenant](scalard_tx_covenant.md)	 - covenant transactions subcommands
		...
		- [protocol](scalard_tx_protocol.md)	 - protocol transactions subcommands
			- [add [protocol-json]](scalard_tx_protocol_add.md)	 - Add a protocol
