## scalard query staking delegations-to
...
Example:
$ <appd> query staking delegations-to scalarvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj

```
scalard query staking delegations-to [validator-addr] [flags]
```
