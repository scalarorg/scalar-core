...
```
      ...
      --config-path string          Configs directory, keep supported chains in each family file such as evm.json or btc.json: 
  ...
  -h, --help                        help for init-files
      ...
      --minimum-gas-prices string   Minimum gas prices to accept for transactions; All fees in a tx must meet this minimum (e.g. 0.01photino,0.001stake) (default "0.007ascal")
