## scalard query staking delegations
...
Example:
$ <appd> query staking delegations scalar1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p

```
scalard query staking delegations [delegator-addr] [flags]
```
