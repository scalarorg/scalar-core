## scalard tx btc confirm-staking-txs

Confirm staking transactions in an EVM chain

```
scalard tx btc confirm-staking-txs <chain> <txID>... [flags]
```
...
```
  ...
  -h, --help                     help for confirm-staking-txs
