...
func DefaultConfig() Config {
	...
	return Config{
		...
		MinGasPrices:      fmt.Sprintf("0.000006%s", scalartypes.BaseDenom),
		AccountTokens:     sdk.TokensFromConsensusPower(1000000000000000000, scalartypes.PowerReduction),
		StakingTokens:     sdk.TokensFromConsensusPower(500000000000000000, scalartypes.PowerReduction),
		BondedTokens:      sdk.TokensFromConsensusPower(100000000000000000, scalartypes.PowerReduction),
		CleanupDir:        true,
